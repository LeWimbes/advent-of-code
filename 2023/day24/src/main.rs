...
impl Solution for Day24 {
    ...
    fn part1(hail: &Self::Input<'_>) -> Self::Output1 {
    ...
    /// p - p_i = t_i * v_i - t * v
    /// (p - p_i) x (v - v_i) = 0
    fn part2(hail: &Self::Input<'_>) -> Self::Output2 {
...
mod tests {
    ...
    aoc_utils::solution_tests!(2023, 24, Day24);

    #[rstest]
    fn part1_test(data1: <Day24 as Solution>::Input<'_>) {
        assert_eq!(
            2,
            count_intersections_in_region(
                &data1,
    ...
    #[rstest]
    fn part2_test(data1: <Day24 as Solution>::Input<'_>) {
        assert_eq!(BigInt::from(47), Day24::part2(&data1));
    }
}
