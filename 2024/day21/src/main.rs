...
impl Solution for Day21 {
    ...
    fn part1(codes: &Self::Input<'_>) -> Self::Output1 {
        get_complexity_sum(codes, 2)
    }

    fn part2(codes: &Self::Input<'_>) -> Self::Output2 {
        get_complexity_sum(codes, 25)
    }
}

aoc_utils::run!(2024, 21, Day21);
...
fn get_complexity_sum<'a>(codes: &<Day21 as Solution>::Input<'a>, indirections: usize) -> usize {
    codes
        .iter()
        .map(|code| {
...
mod tests {
    ...
    aoc_utils::solution_tests!(2024, 21, Day21);

    #[rstest]
    fn part1_test(data1: <Day21 as Solution>::Input<'_>) {
        assert_eq!(126_384, Day21::part1(&data1));
    }
}
